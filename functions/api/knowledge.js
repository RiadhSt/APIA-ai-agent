...
// ===== قسم 1: الأسئلة والأجوبة (أولوية قصوى) =====
export const myFAQ = `
<faq>

<!-- ========================================== -->
<!-- 📁 1. التعريفات الأساسية / Définitions     -->
<!-- ========================================== -->
<faq_category name="التعريفات الأساسية">
...
// ===== قسم 2: المعرفة العامة (مرجع ثانوي) =====
export const myKnowledge = `

<knowledge_index>
الفئات المتاحة في قاعدة المعرفة:
1. تقديم عام لتونس والإطار الاقتصادي
2. تقديم عام لوكالة APIA ونشاطاتها
3. مجالات الاستثمار حسب الولاية (24 ولاية)
4. محاضن المؤسسات الفلاحية
5. المعارض والصالونات (داخل تونس وخارجها)
6. الصالون الدولي SIAT 2026
7. دليل المستثمر الأجنبي (بالفرنسية)
8. الشركات الأهلية
9. نتائج الاستثمار الفلاحي الخاص 2025
10. الامتيازات الجبائية للاستثمار الفلاحي
11. الامتيازات المالية (المنح) وسقوفها ونسبها
12. قائمة مكونات المشروع والمنح المقابلة (الملحق 1 للأمر 389)
13. قواعد احتساب المنح وسقوفها وآجال البت
14. توزيع تعهد الملفات بين الهياكل
15. تركيبة لجان إسناد الامتيازات وسير عملها
16. صرف المنح: احتساب نسب الإنجاز وإجراءات الصرف
17. وثائق ملفات صرف الامتيازات المالية
18. التصريح بالاستثمار (إجراءات، آجال، شروط)
19. مقررات إسناد الامتيازات المالية (المصادقات)
20. تحيين التصريح أو مقرر إسناد الامتيازات
21. تصنيف عمليات الاستثمار (الصنف أ و ب)
22. تعريف المصطلحات الأساسية
23. قانون الاستثمار عدد 71 لسنة 2016
</knowledge_index>

<!-- ============================================================ -->
<topic
  name="تقديم عام لتونس"
  category="الإطار الاقتصادي العام"
  keywords="تونس, موقع, اقتصاد, استثمار, شراكة, اتحاد أوروبي, مقومات">
...
- الاستقرار السياسي والاجتماعي الذي يتجلى خاصة من خلال توقيع مختلف الأحزاب والمنظمات الوطنية على الميثاق الوطني وكذلك من خلال مختلف آليات التحاور والتشاور التي تمّ سنها للغرض وهو ما مكن من إرساء مناخ اجتماعي ملائم للتنمية الاقتصادية والاجتماعية؛
- تمتع تونس بسمعة طيبة بالأسواق الاقتصادية والمالية العالمية إضافة إلى توقيع تونس عديد من الاتفاقيات لضمان الاستثمار وعدم ازدواجية الضرائب وكذلك الإتفاقيات المتعلقة بالتحكيم الدولي وبحماية الملكية الفكرية. علما وان تونس تحتل المرتبة الأولى على المستوى الإفريقي ومكانة متميزة بين البلدان الصاعدة في مجال ثقة المستثمرين؛
- توفر نظام جبائي مشجع على الاستثمار يبرز خاصة من خلال أحكام مجلة تشجيع الاستثمارات التي نصت على امتيازات مشتركة لمختلف الأنشطة وعلى امتيازات خصوصية لبعض الأنشطة ذات الأولوية مثل الفلاحة والصيد البحري.
- هياكل مساندة ملائمة وضعتها تونس قصد النهوض بالاستثمار:
  - وكالة النهوض بالاستثمارات الفلاحية؛
  - وكالة النهوض بالصناعة و المبادرة؛
  - وكالة النهوض بالاستثمار الخارجي؛
  - مركز النهوض بالصادرات؛
  - المراكز الفنية؛
  - الشبابيك الموحدة لبعث المؤسسات في عديد الولايات؛
  - شبكة إتصالات ملائمة.
- وجود منظومة متطورة للنقل: حيث توجد بتونس 8 مواني تجارية مجهزة بكافة المرافق الضرورية وتؤمن النقل بين تونس ومواني "مرسيليا" و"جنوة" و"برشلونة" بصفة منتظمة وفي زمن لا يفوق 24 ساعة. كما تتميز البنية الأساسية في مجال النقل بوجود 7 مطارات دولية موزعة على مختلف مناطق البلاد تؤمن الرحلات الجوية إلى مختلف البلدان بأوروبا والشرق الأوسط وإفريقيا. ومن جهة أخرى تمكن البنية التحتية و شبكة الطرقات المتطورة التي يقدر طولها بحوالي 32 ألف كلم من الوصول بسرعة إلى مختلف المناطق الاقتصادية بالبلاد والربط مع الدول المجاورة.
- توفر شبكة إتصالات ملائمة حيث مكنت الاستثمارات الضخمة المنجزة حديثا في مجال الاتصالات من تجهيز البلاد ببنية أساسية اتصالية عصرية ومن شبكات تمكن من تغطية كافة المناطق ومن توفير خدمات الهاتف القار والجوال والأنترنات والخدمات الأخرى لنقل المعطيات.
...
## التسهيلات الممنوحة للمستثمر الأجنبي
- حرية تحويل المرابيح وقيمة بيع الأصول التي على ملك المستثمر الأجنبي بما في ذلك الربح المحقق عند عملية البيع وفقا لما جاء في القانون عدد 48 لسنة 1993 بتاريخ 03 ماي 1993 المقر لحرية التحويلات المتعلقة بالدّفوعات تجاه الخارج.
...
- عدم الازدواج الضريبي الذي تم إقراره في إطار الاتفاقيات الثنائية الممضاة مع عديد الدول منها خاصة ألمانيا والنمسا وبلجيكيا وكندا وكوريا الجنوبية والدنمارك ومصر وإسبانيا وفرنسا واندونيسيا وإيطاليا والأردن والنرويج وبريطانيا العظمى والسويد والولايات المتحدة الأمريكية وبلدان إتحاد المغرب العربي.
...
<!-- ============================================================ -->
<topic
  name="تقديم عام لوكالة النهوض بالاستثمارات الفلاحية"
  category="APIA"
  keywords="APIA, وكالة, تعريف, نشاط, وسائل, دراسات, خدمات, مجاني">
...
## وسائل الوكالة
تتوفر لدى وكالة النهوض بالاستثمارات الفلاحية العديد من الوسائل التي من شأنها أن تدعم فرص الاستثمار بتونس في قطاعي الفلاحة والصيد البحري والخدمات المرتبطة بهما. وتمكن الوكالة من توفير أفضل الظروف لتجسيم البرامج المنوطة بعهدتها، نذكر منها بالخصوص:
...
دراسات تهدف إلى إسناد المنتجات التونسية علامات جودة (تسميات مثبتة للأصل، بيانات المصدر، علامات جغرافية محمية، فلاحة بيولوجية...):
...
<!-- ============================================================ -->
<topic
  name="مجالات الاستثمار حسب الولاية"
  category="فرص الاستثمار الجهوية"
  keywords="ولاية, مجالات استثمار, جهوي, فرص, قطاعات">

# مجالات الاستثمار بولاية تونس
- تكثيف الزراعات الجديدة القابلة للتصدير على غرار القنارية،
- تأهيل وتركيز هياكل مهنية لدعم الخدمات الفلاحية،
- تركيز وحدات لتحويل وتكييف المنتوجات الفلاحية ومنتوجات الصيد البحري.

# مجالات الاستثمار بولاية أريانة
- تكثيف وتطوير الزراعات القابلة للتصدير مثل غراسة القنارية،
...
# مجالات الاستثمار بولاية منوبة
- تكثيف زراعة الخضروات المميّزة للجهة على غرار القنارية والطماطم المعدة للتجفيف،
...
# مجالات الاستثمار بولاية بنزرت
- إستغلال الموارد المائية الجوفية المتوفرة ببعض الجهات،
- إحداث مسلخ للدواجن،
- تربية الأحياء المائية بالمسطحـات المائية (السدود الكبرى، السدود التلية والبحيرات الجبلية)،
...
# مجالات الاستثمار بولاية سليانة
- غراسة الأشجار المثمرة والزياتين،
...
# مجالات الاستثمار بولاية جندوبة
- غراسة الأشجار المثمرة والزياتين،
- ادماج تربية الأبقار وتسمين العجول بالمناطق السقوية،
- بعث مراكز لتربية الأراخي،
- بعث وحدات لتبريد الحليب،
- تربية الماشية الصغرى،
- بعث وحدات خزن وتبريد وتكييف المنتوجات الفلاحية،
...
# مجالات الاستثمار بولاية القيروان
...
# مجالات الاستثمار بولاية المنستير
...
- تهيئة مناطق سقوية حول الآبار الجيوحرارية لاستغلال مياه التسخين في انتاج الأعلاف،
- انتاج مشاتل الخضروات والأشجار المثمرة،
- تجميع المحار وتهيئة مركز تصفية،
- تأهيل وتجديد مراكب الصيد البحري،
- تربية الطحالب البحرية بالأحواض،
- بعث مراكز لتجميع الحليب،
- إحداث مذابح ومسالخ ووحدات لتحويل اللحوم،
- إحداث مركز فرز وتكييف المنتوجات البيولوجية،
- تأهيل وإحداث تعاونيات خدمات فلاحية.

# مجالات الاستثمار بولاية مدنين
- غراسة الأشجار المثمرة البدرية (خوخ، عنب...) الموجهة للتصدير مع التركيز على الأصناف المتأقلمة مع المناخ،
...
- إدماج تربية الماشية المكثفة والنصف مكثفة (بقر حلوب، ماعز محسن، أغنام، إبل)،
- إنتاج اللحوم الحمراء (تسمين العجول، تسمين الخرفان، تسمين القعدان)،
- تربية الماشية الصغرى (السمان، الديك الرومي، النعام)،
...
- إحداث مزارع لتسمين القفالة ومراكز لفرز وتنقية المحار،
...
# مجالات الاستثمار بولاية تطاوين
...
- تحويل وتكييف التمور،
- تثمين فواضل الواحة (إنتاج السماد العضوي والاعلاف...).

# مجالات الاستثمار بولاية توزر
- تكثيف غراسة النخيل،
...
- تثمين مخلفات الواحة (انتاج الأعلاف، إنتاج السماد العضوي)،
...
<!-- ============================================================ -->
<topic
  name="محاضن المؤسسات الفلاحية"
  category="دعم الباعثين"
  keywords="محاضن, باعثون شباب, تكوين, مرافقة, خريجون, مشاريع مجددة">

# ما الهدف من تركيز محاضن المؤسسات؟
في نطاق سياسة الدولة الرامية إلى مزيد دفع الإستثمار والحث على بعث مشاريع ذات قيمة مضافة عالية وتشجيع المبادرة الخاصة لتنمية العمل الحر، جاء قرار المجلس الوزاري المنعقد بتاريخ 06 ماي 2002 يدعو إلى بعث محاضن في مؤسسات التعليم العالي الفلاحي. وتجسيما لهذا القرار، أبرمت وكالة النهوض بالإستثمارات الفلاحية في هذا المجال إتفاقية إطارية مع مؤسسة البحث والتعليم العالي الفلاحي تنص على إحداث محاضن مؤسسات في معاهد ومدارس التعليم العالي الفلاحي، فتم إحداث 7 محاضن مؤسسات فلاحية بكل من:
...
وبذلك يبلغ العدد الجملي للمحاضن المحدثة بمؤسسات البحث و التعليم العالي الفلاحي 7 محاضن تغطي أكثر من 17 إختصاصا على غرار مجالات الفلاحة والصيد البحري و الصناعات الغذائية والبيوتكنولوجيا. وتتولى لجنة إشراف على المستوى الوطني رسم الإستراتيجية العامة للمحاضن ومتابعة أنشطتها. كما تتولى لجنة تسيير خاصة بكل محضنة ضبط برامج نشاطها ومتابعة نتائجها وذلك عبر إدارة خاصة بكل محضنة.

# ماذا نقصد بمحاضن المؤسسات؟
تمثل محضنة المؤسسات الفلاحية فضاء استقبال، يوفر مقرات و مساعدات وخدمات تتماشى و الاحتياجات الخاصة للمشاريع في طور الإحداث أو حديثة التكوين.
...
- تنظيم أيام وورشات إعلامية لفائدة الطلبة وحاملي الشهادات العليا بكل محضنة،
- التعريف بالمحاضن خلال التظاهرات الجهوية والوطنية على غرار ندوات الإستثمار،
- تنظيم حلقات عمل وموائد مستديرة للمساعدة على بلورة أفكار المشاريع مع الإستعانة بالكفاءات العلمية والخبرات المهنية.

**المرحلة الثانية: مرافقة الباعث خلال دراسة المشروع**
- توفير خبراء ومؤطرين طوال مدة التأطير التي تصل إلى 24 شهرا نظرا لخصوصيات القطاع، (100 مؤطر من الكفاءات الجامعية والبحثية الفلاحية و50 مؤطر فني و33 مؤطر من البنوك و20 مؤطر في المجال الإقتصادي والمالي)،
- توفير محطات للتجارب النموذجية لأفكار المشاريع المجددة،
- المرافقة خلال إعداد مخطط الأعمال،
- تنمية وتطوير مهارات التصرف عبر تكوين إضافي وتربصات،
- توفير فضاء مجهز لكل صاحب مشروع يمثل مقر وقتي للمؤسسة.

**المرحلة الثالثة: مرافقة الباعث خلال تمويل المشروع**
- المساندة خلال البحث على مصادر التمويل،
- المساندة خلال الحصول على إمتيازات مجلة تشجيع الإستثمارات.

**المرحلة الرابعة: مساندة الباعث خلال إنجاز المشروع**
- المرافقة خلال تركيز المشروع من خلال تذليل الصعوبات لتمكين الباعث من إنجاز المشروع في أحسن الآجال،
- التدخل للمساندة خلال الإجراءات المتعلقة بصرف القروض والإمتيازات وخلال الدخول في طور النشاط ثم التطوير.
...
# الاحاطة والتكوين - مساندة الباعثين
...
<!-- ============================================================ -->
<topic
  name="الأنشطة التنموية والمعارض والصالونات"
  category="المعارض والتظاهرات"
  keywords="معارض, صالونات, خارج, 2026, BIOFACH, SIA, SEAFOOD, SIAT, شراكة">
...
ومن هذا المنطلق وضمن نشاطها التنموي، ما فتئت الوكالة أن تقوم بالتعاون مع السفارات التونسية و البعثات التجارية بالخارج و الباعثين و المصدرين بتشخيص أهم الصالونات و المعارض الفلاحية المختصة التي من شأنها أن تساهم في بعث مشاريع شراكة تونسية أجنبية وتنمية صادرات المنتجات الفلاحية التونسية من ناحية وتنمية المعارف لدى المصدرين و الباعثين و العاملين الاقتصاديين في هذا المجال من ناحية أخرى.
...
<!-- ============================================================ -->
<topic
  name="الصالون الدولي للاستثمار الفلاحي والتكنولوجيا SIAT 2026"
  category="المعارض والتظاهرات"
  keywords="SIAT, سيات, 2026, 2024, قصر المعارض, الكرم, منتدى, شراكة, GREEN TIC">

# الصالون الدولي للاستثمار الفلاحي والتكنولوجيا سيات 2026
...
انطلقت وكالة النهوض بالاستثمارات الفلاحية في تنظيم الصالون الدولي للاستثمار الفلاحي والتكنولوجيا منذ سنة 1994 تحت إشراف وزارة الفلاحة والموارد المائية والصيد البحري وهو صالون مختص في الشأن الفلاحي ويعد من أبرز الفعاليات الاقتصادية في تونس حيث يلتئم مرة كل سنتين آخر دورة كانت سنة 2022 وهو يتيح الفرصة للمستثمرين في قطاعي الفلاحة والصيد البحري ورجال الاعمال والمزودين واصحاب التقنيات والشركات الناشئة والباحثين لمناقشة سبل تطوير اساليب العمل والانتاج وتعزيز العلاقات الاقتصادية وتطوير الشراكة.
...
تهدف ورشات البحث العلمي الفلاحي الى تقديم حلول علمية تطبيقية لمشاغل الفلاحين والمستثمرين في علاقة بالتغيرات المناخية وندرة الموارد الطبيعية والتوجه نحو الفلاحة المستدامة وقد تم اختيار المواضيع بالتعاون مع مؤسسة البحث والتعليم العالي الفلاحي وهي كالاتي:
...
وفي اطار متابعة فعاليات الصالون، نظمت وكالة النهوض بالاستثمارات الفلاحية يوم الخميس 1 نوفمبر 2024 ملتقى الشراكة الفلاحية الذي افتتحته المديرة العامة للوكالة السيدة انجي الدقي حيث اكدت في كلمة القتها بهذه المناسبة على دور مشاريع الشراكة الفلاحية في دفع الاستثمار الفلاحي ببلادنا وفي تحقيق شراكات مربحة للتونسيين ونظرائهم الاجانب علاوة على الفرصة التي تتيحها تبادل الخبرات والتجارب في تحقيق القيمة المضافة العالية في القطاع الفلاحي كما اشارت المديرة العامة الى جملة الحوافز والتشجيعات التي يتمتع بها المستثمر الاجنبي في قانون الاستثمار.
...
<!-- ============================================================ -->
<topic
  name="دليل المستثمر الأجنبي - Guide de L'INVESTISSEUR ÉTRANGER 2022"
  category="الاستثمار الأجنبي"
  keywords="investisseur étranger, partenariat, terres agricoles, location, incitations, APIA antennes, fiscalité, charges sociales">
...
<topic
  name="دليل الشركات الأهلية - تعريف ومراجع قانونية"
  category="الشركات الأهلية والاقتصاد التضامني"
  keywords="شركة أهلية, تعريف, مرجع قانوني, مرسوم 15, حوكمة, أهداف">
توطئة: يندرج دليل الشركات الأهلية في إطار توفير رؤية واضحة وشاملة حولها، باعتبارها خيارا استراتيجيا يهدف إلى تحقيق الرفاه الاجتماعي والاقتصادي بتونس في إطار السياسة العامة للدولة. ويمثل هذا الدليل مرجعًا عمليا يوضح مفهوم الشركات الأهلية ومسار إحداثها القانوني وطرق تسييرها ومرافقة باعثيها وما أقرّ لفائدتها من منح وامتيازات، بما يعزّز المبادرة الجماعية الأهلية ويساهم في دفع التنمية على المستويين المحلي والوطني.

المحور الأول: مفهوم الشركة الأهلية

1. التعريف: الشركة الأهلية هي شخص معنوي تحدثه مجموعة من أهالي الجهة (المشاركين) يكون الهدف منه تحقيق التنمية الجهوية والمحلية وتعتمد أساسا على المبادرة الجماعية والتنمية التضامنية.
...
3. حوكمة الشركات الأهلية: تخضع الشركات الأهلية لقواعد الحوكمة الرشيدة والشفافية وإشراك أعضاء الجهة في اتخاذ القرار وتوزيع العوائد بما يضمن المصلحة الجماعية.
...
1. التأطير والمرافقة:
تتولى وزارة التشغيل والتكوين المهني عبر هياكلها الجهوية والمركزية والهياكل والمؤسسات الشريكة (مثل وكالة النهوض باالاستثمارات الفلاحية APIA، ووكالة النهوض بالصناعة والتجديد APII) مرافقة باعثي الشركات الأهلية في إعداد دراسات الجدوى الفنية والاقتصادية والمساعدة على استكمال الإجراءات القانونية.
...
<topic
  name="نتائج الاستثمار الفلاحي الخاص لسنة 2025 - توطئة وتصاريح"
  category="الإحصائيات ونتائج الاستثمار"
  keywords="2025, استثمار فلاحي خاص, نتائج, تصاريح, استثمارات مصرح بها, خدمات فلاحية">
نتائج الاستثمار الفلاحي الخاص لسنة 2025

توطئة: تعمل وكالة النهوض بالاستثمارات الفلاحية على النهوض بالاستثمار الفلاحي الخاص وتوجيهه بما يترجم التوجهات الاستراتيجية لوزارة الفلاحة والموارد المائية والصيد البحري، وبما يتماشى مع رؤيتها الهادفة لفلاحة مستدامة ودامجة وصامدة تدعم التنمية الريفية وتعزز الأمن الغذائي والمائي. وفي هذا الإطار، واصلت الوكالة أنشطتها وبرامج تدخلها خلال سنة 2025 بالعمل على توجيه الاستثمار الخاص:
...
تطورت نسبة القروض لتبلغ 30% من قيمة الاستثمارات المصادق عليها من قبل الوكالة (بقيمة 154.6 م د)، بعد أن كانت في حدود 25% خلال سنة 2024. وقد ساهمت قروض الاستثمار في تمويل عدد 1353 مشروعا أي بنسبة 47% من مجموع المشاريع المصادق عليها من قبل الوكالة. مع الإشارة أن هذه النسبة، لم تتجاوز 3.3% بالنسبة لعمليات الاستثمار التي تخص صغار الفلاحين والصيادين المصادق عليها من قبل المندوبيات الجهوية للتنمية الفلاحية.
...
<topic
  name="تفاصيل الامتيازات والحوافز الجبائية للاستثمار الخاص الفلاحي"
  category="الحوافز والامتيازات"
  keywords="امتيازات جبائية, طرح مداخيل, ضريبة, إعفاء, TVA, معاليم ديوانية, تسجيل أراضي">
...
القطاع المستهدف: الفلاحة والصيد البحري وتربية الأحياء المائية
تفاصيل الامتياز:
...
نوع الامتياز الجبائي: طرح المداخيل أو الأرباح بعنوان الاستغلال من أساس الضريبة
القطاع المستهدف: الخدمات والتحويل الأولي داخل مناطق التنمية الجهوية
تفاصيل الامتياز:
...
نوع الامتياز الجبائي: طرح المداخيل أو الأرباح بعنوان الاستغلال من أساس الضريبة
القطاع المستهدف: الخدمات والتحويل الأولي خارج مناطق التنمية الجهوية
تفاصيل الامتياز:
...
نوع الامتياز الجبائي: طرح المداخيل أو الأرباح بعنوان إعادة الاستثمار خارج المؤسسة في الاكتتاب في رأس المال الأصلي أو الترفيع فيه من أساس الضريبة
القطاع المستهدف: الفلاحة والصيد البحري وتربية الأحياء المائية والخدمات والتحويل الأولي داخل مناطق التنمية الجهوية
تفاصيل الامتياز:
...
نوع الامتياز الجبائي: طرح المداخيل أو الأرباح بعنوان إعادة الاستثمار خارج المؤسسة في الاكتتاب في رأس المال الأصلي أو الترفيع فيه من أساس الضريبة
القطاع المستهدف: الفلاحة والصيد البحري وتربية الأحياء المائية والخدمات والتحويل الأولي
تفاصيل الامتياز:
...
نوع الامتياز الجبائي: توقيف العمل بالأداء على القيمة المضافة
القطاع المستهدف: الفلاحة والصيد البحري وتربية الأحياء المائية
تفاصيل الامتياز:
...
نوع الامتياز الجبائي: توقيف العمل بالأداء على القيمة المضافة
القطاع المستهدف: الخدمات والتحويل الأولي
تفاصيل الامتياز:
- التخفيض في نسبة الأداء على القيمة المضافة إلى 6% بالنسبة لعمليات التوريد للتجهيزات التي ليس لها مثيل مصنوع محليا والواردة بالقائمة عدد 1.
...
- التخفيض في نسبة الأداء على القيمة المضافة إلى 6% في الحالات الأخرى.
...
نوع الامتياز الجبائي: الإعفاء من المعاليم الديوانية
القطاع المستهدف: الفلاحة والصيد البحري وتربية الأحياء المائية
تفاصيل الامتياز:
...
نوع الامتياز الجبائي: معاليم التسجيل الموظفة على اقتناء الأراضي الفلاحية
تفاصيل الامتياز:
...
<topic
  name="تفاصيل الامتيازات المالية والمنح الممنوحة للاستثمار الخاص الفلاحي"
  category="الحوافز والامتيازات"
  keywords="منحة, قطاعات أولوية, منظومات اقتصادية, أداء اقتصادي, تحسين إنتاجية, استثمارات لامادية, بحث وتطوير, تنمية جهوية, تنمية مستدامة, قدرة تشغيلية, مساهمة في رأس المال">
...
ملاحظات هامة: تشمل كل القطاع الفلاحي والصيد البحري وتربية الأحياء المائية.
...
نسبة المنحة للصنف ب: 15%
السقف المالي: 1 مليون دينار
ملاحظات هامة: قائمة المنظومات محددة بالملحق 1 من الأمر عدد 389.
...
ملاحظات هامة: تسند عند الإحداث. تبلغ النسبة 60% بالنسبة للهياكل المهنية والشركات الأهلية.
...
نسبة المنحة للصنف ب: 50%
السقف المالي: 500 ألف دينار
ملاحظات هامة: تسند عند الإحداث والتوسعة والتجديد. تبلغ النسبة 60% بالنسبة للهياكل المهنية والشركات الأهلية.
...
نسبة المنحة للصنف ب: 50%
السقف المالي: 500 ألف دينار
ملاحظات هامة: تشمل منحة الدراسة بسقف 20 ألف دينار.
...
ملاحظات هامة: حسب الملحق 1 من الأمر عدد 389.
...
ملاحظات هامة: مخصصة للهياكل المهنية.
...
ملاحظات هامة: القطاع الفلاحي مستثنى، وتشمل فقط أنشطة التحويل والخدمات.
...
ملاحظات هامة: تشمل التحويل الأولي المندمج وغير المندمج والخدمات.
...
ملاحظات هامة: تخص مشاريع معالجة التلوث المائي والهوائي والتقنيات النظيفة.

--------------------------------------------------

نوع المنحة: منحة تطوير القدرة التشغيلية

اسم المنحة: تكفل الدولة بمساهمة الأعراف في النظام القانوني للضمان الاجتماعي بالنسبة للمنتدبين لأول مرة وبصفة قارة.

--------------------------------------------------

اسم المنحة: تكفل الدولة بنسبة من الأجور المدفوعة للأعوان التونسيين حسب نسبة التأطير بعنوان حاملي الشهائد الجامعية أو مؤهل تقني سام.

--------------------------------------------------

نوع المنحة: مساهمة في رأس المال محملة على موارد الصندوق التونسي للاستثمار

اسم المنحة: مساهمة في رأس المال محملة على موارد الصندوق التونسي للاستثمار.
...
<topic
  name="توزيع تعهد ملفات الاستثمار بين الهياكل"
  category="النصوص القانونية والإجراءات"
  keywords="توزيع الملفات, APIA, مندوبيات جهوية, شركات إحياء, تحويل أولي بيولوجي, قروض عقارية, مركزي, جهوي">
# توزيع تعهد الملفات
...
<topic
  name="كل مكونة من مكونات المشروع والمنحة التي تقابلها - الملحق 1 للأمر 389"
  category="الحوافز والامتيازات"
  keywords="منحة قطاعات أولوية, منحة منظومات اقتصادية, خدمات فلاحية, تحويل أولي, خدمات صيد بحري, تكنولوجيات حديثة, تحسين إنتاجية, استثمارات لامادية, بحث وتطوير">
...
* الأجهزة الطرفية للمتابعة عبر الأقمار الاصطناعية في الصيد البحري.
...
<topic
  name="كيفية وقواعد احتساب المنحة وسقفها وآجال البت"
  category="الحوافز والامتيازات"
  keywords="احتساب المنح, TVA, أسقف المنح, جمع المنح, سقف إجمالي, منع الجمع, إسناد المنح, آجال البت">
...
<topic
  name="تركيبة لجان إسناد الامتيازات وسير عملها"
  category="النصوص القانونية والإجراءات"
  keywords="لجنة وطنية, لجان جهوية, إسناد امتيازات, تركيبة, سير عمل, نصاب قانوني, مداولات, إمضاء">
...
<topic
  name="صرف المنح: احتساب نسب الإنجاز وإجراءات الصرف"
  category="الحوافز والامتيازات"
  keywords="صرف المنح, أقساط الصرف, نسبة إنجاز, تقرير سنوي, أجل إنجاز, وثائق, معاينة ميدانية, منحة دراسة, سحب جزئي">
...
نسبة إنجاز المشروع = (مجموع (نسبة الإنجاز المادي لكل مكونة × قيمة الاستثمار المصادق عليه للمكونة)) / (القيمة الجملية للاستثمار المصادق عليه)
...
* **أجل الإنجاز القانوني:** يجب إنجاز برنامج الاستثمار خلال 4 سنوات من تاريخ التصريح، قابلة للتمديد
...
<topic
  name="التصريح بالاستثمار - إجراءات وآجال"
  category="النصوص القانونية والإجراءات"
  keywords="تصريح بالاستثمار, إضبارة وحيدة, شهادة, تغيير شهادة, تونسيون بالخارج, صلوحية">
# التصريح بالاستثمار
...
<topic
  name="التصريح بالاستثمار - أهداف وتصنيف وإجراءات"
  category="النصوص القانونية والإجراءات"
  keywords="أهداف, تصنيف, صنف أ, صنف ب, إجراءات, توزيع المهام, هيكل تمويل">
...
<topic
  name="مقررات إسناد الامتيازات المالية (المصادقات)"
  category="النصوص القانونية والإجراءات"
  keywords="مقرر إسناد, شروط, وثائق, دراسات, إجراءات, آجال, مراجع قانونية">
# مقررات المصادقة

## الخدمة: الحصول على مقرر إسناد امتيازات من صنف "أ" أو "ب"
...
<topic
  name="إجراءات وآجال تعهد ملفات مطالب الانتفاع بالامتيازات المالية"
  category="النصوص القانونية والإجراءات"
  keywords="إيداع المطلب, منحة القدرة التشغيلية, منظومة قديمة, منظومة جديدة, دراسة فنية, هيكل تمويل">
...
<topic
  name="تحيين التصريح أو مقرر إسناد الامتيازات"
  category="النصوص القانونية والإجراءات"
  keywords="تحيين, تصريح, مقرر إسناد, تغيير امتيازات, إصلاح أخطاء, إحالة مشروع, قاعدة معطيات">
...
<topic
  name="تصنيف عمليات الاستثمار إلى الصنفين أ أو ب"
  category="النصوص القانونية والإجراءات"
  keywords="تصنيف, صنف أ, صنف ب, فلاحة, صيد بحري, تربية أحياء مائية, خدمات, تحويل أولي, شركات تعاونية, شركات أهلية">
...
<topic
  name="تعريف بعض المصطلحات"
  category="النصوص القانونية والإجراءات"
  keywords="قطاعات ذات أولوية, منظومات اقتصادية, إحداث, توسعة, تجديد, تحويل أولي مندمج, شروع, دخول طور النشاط, فواتير, مرافق مختص, مؤسسات مصدرة كليا">
# تعريف بعض المصطلحات
...
هي الأنشطة التي تعتمد بشكل أساسي على تثمين الموارد الإنشائية والفلاحية والمخزون الطبيعي والثقافي من خلال التصنيع والتوظيف بمناطق الإنتاج وتساهم في تطوير سلاسل القيم من خلال التحويل الجذري لطبيعة المنتوج، وهي تضم منظومتين: منظومة الزراعات الجيوحرارية ومنظومة النباتات الطبية والعطرية. وتسند الامتيازات المتعلقة بالمنظومات الاقتصادية لعمليات الاستثمار الخاصة بالتحويل فقط.
...
## التوسعة
هي كل عمليات الاستثمار الموالية لعمليات الإحداث أو لعمليات التوسعة ومرتبطة بها:
...
* بالنسبة للاستثمارات في نفس النشاط في قطاعات الصيد البحري إذا استعملت نفس الموارد أو وسائل الإنتاج (استثمارات تخص نفس المركب مثلا)،
* بالنسبة لتربية الأحياء المائية إذا تمت في نفس الموقع أو استعملت نفس الموارد أو وسائل الإنتاج،
* بالنسبة للخدمات والتحويل الأولي إذا تمت في نفس المكان أو استعملت نفس الموارد أو وسائل الإنتاج،
...
* التجهيزات الصغيرة المعدة للتربية مثل أوعية الحلب، آلات الحلب، بيوت النحل، تجهيزات التغذية والشراب للدجاج والأرانب والتجهيزات الصغيرة لخدمة الأرض والجني والمداواة وبلاستيك البيوت المكيفة وغيرها والصناديق البلاستيكية والتجهيزات المعتمدة في الزراعات خارج التربة: مدتها الاندثارية 3 سنوات.
* تهيئة المراكب وتجهيزات الصيد البحري وتربية الأحياء المائية: مدتها الاندثارية تحدد طبقا لمنشور وزير الفلاحة عدد 105 بتاريخ 07 ماي 2007 ومحضر جلسة العمل بتاريخ 21/03/2012.
* الجرارات وتوابعها ومعدات الري وتجهيزات الآبار والمولدات الكهربائية والشاحنات والشباك الواقية وأقفاص تربية الدجاج والأرانب: مدتها الاندثارية 6 سنوات.
* الحاصدات والتجهيزات الكبرى مثل تجهيزات قاعات الحلب والمذابح والمعاصر ومعدات العزل والتبريد وتجهيزات التهوئة والتبريد وصوامع الأعلاف وتجهيزات التغذية الآلية بالنسبة لتربية الدجاج: مدتها الاندثارية 9 سنوات.
* الغراسات السقوية باستثناء الزياتين التي تخضع للترخيص: مدتها الاندثارية 15 سنة.
* تهيئة البناءات: مدتها الاندثارية 10 سنوات.
...
حسب الفصل 25 من القانون عدد 64 لسنة 1991 المؤرخ في 29 جويلية 1991 المتعلق بالمنافسة والأسعار، يجب أن تكون كل عملية بيع منتوج أو إسداء خدمة لنشاط مهني موضوع فاتورة. وعلى البائع أن يسلم الفاتورة عند القيام بالبيع أو إسداء الخدمة وعلى المشتري المطالبة بها كما يجب تحرير الفاتورة في نظيرين ويتحتم على كل من البائع والمشتري الاحتفاظ بها لمدة لا تقل عن ثلاث سنوات ويجب أن تتضمن الفاتورة التنصيصات الوجوبية التالية: 
* الرقم التسلسلي، 
...
تعتبر مؤسسات مصدرة كليا المؤسسات التي تبيع كامل سلعها أو منتجاتها أو تسدي كامل خدماتها خارج البلاد التونسية أو التي تنجز كامل خدماتها بالبلاد التونسية والتي يتم استعمالها بالخارج. كما تعتبر مؤسسات مصدرة كليا المؤسسات التي تبيع كامل منتجاتها أو تسدي كامل خدماتها للمؤسسات المصدرة كليا.
...
<topic
  name="تقديم عام لقانون الاستثمار عدد 71 لسنة 2016"
  category="النصوص القانونية والإجراءات"
  keywords="قانون 71, 2016, أهداف, تعريف الاستثمار, حوافز, أحكام انتقالية">
# قانون الاستثمار
...
وتم تعريف الاستثمار على أنّه كل توظيف مستدام لأموال يقوم به المستثمر لإنجاز مشروع من شأنه المساهمة في تنمية الاقتصاد التونسي مع تحمل مخاطره ويكون في شكل عمليات استثمار مباشر (إحداث، توسعة، تجديد) أو استثمار بالمساهمة النقدية أو العينية في رأس مال شركات بالبلاد التونسية سواء عند تكوينها أو عند الترفيع في رأس مالها أو اقتناء مساهمة في رأس مالها.
...
كما تم إقرار حوافز في شكل مساهمة في رأس المال محمّلة على موارد الصندوق التونسي للاستثمار وقروض عقارية.

وتم كذلك وضع حوافز جبائية ومالية للمشاريع ذات الأهمية الوطنية والتي تم تعريفها على أساس حجمها الاستثماري (يفوق 50 م د) أو طاقتها التشغيلية (500 موطن شغل) واستجابتها على الأقل لأحد الأهداف الواردة أعلاه.
...
وتجدر الإشارة إلى أنّ الاستثمار في القطاعات الاقتصادية يخول لها الانتفاع بامتيازات جبائية تم تضمينها في قانون عدد 8 لسنة 2017 المؤرخ في 14 فيفري 2017 يتعلّق بمراجعة منظومة الامتيازات الجبائية ونصوصه التطبيقية.
</topic>
`;
// ===== تجميع الكل مع تحديد الأولويات =====
export const myKnowledgeBase = { faq: myFAQ, knowledge: myKnowledge };
