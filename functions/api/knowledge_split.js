// 1. الملف الشامل كاملاً (الملف القديم كما هو)
export const myKnowledgeBase = `  <topic name="تقديم عام لتونس">
...
// 2. قسم المعلومات العامة والقوانين فقط
export const generalKnowledge = `  <topic name="تقديم عام لتونس">
# الإطار الاقتصادي التونسي
...
// 3. قسم المنح والامتيازات الحافزة فقط
export const investmentKnowledge = `<topic name="Guide de L'INVESTISSEUR ÉTRANGER 2022 - APIA">
    Guide de L'INVESTISSEUR ÉTRANGER 2022
    Agence de Promotion des Investissements Agricoles
    ΑΡΙΑ
    Ensemble, pour des projets fructueux
...
// 4. قسم الأنشطة التنموية والقطاعات فقط
export const developmentKnowledge = `  <topic name="الأنشطة التنموية والمعارض والصالونات بتونس وبالخارج">
